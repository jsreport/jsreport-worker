...
module.exports = (options = {}) => {
  ...
  if (options.workerEnableRequestTempFiles === true || options.workerEnableRequestTempFiles === 'true') {
    console.log(`worker read/save request/response payload properties using temp files is enabled`)
